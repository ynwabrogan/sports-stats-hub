...
export function StatInfoProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <SetHoveredStatContext.Provider value={setHoveredKey}>
      <div className="sticky top-0 z-30 mb-8 max-h-60 overflow-y-auto rounded-md border border-gray-200 bg-white p-3 text-xs text-gray-700 shadow-sm dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200">
        {def ? (
          <>
